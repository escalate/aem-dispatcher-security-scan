...
class TestSecurityScanner(unittest.TestCase):
    ...
    def test_resource_path_default(self):
        ...
        self.assertEqual(
            620, len(scanner.paths), "Default security URL list contains 620 paths!"
        )
    ...
    def test_load_paths_file_invalid_path(self):
        ...
        self.assertRaises(
            FileNotFoundError,
            scanner.load_paths,
            resource_path="tests/fixtures/paths-from-file-not-exist.txt",
        )
    ...
    def test_retrieve_path_response_dispatcher_invalidate(self):
        ...
        self.assertEqual(
            status.url, "http://localhost:8090/dispatcher/invalidate.cache"
        )
